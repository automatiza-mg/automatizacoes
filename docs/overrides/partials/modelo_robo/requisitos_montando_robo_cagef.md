...
:fontawesome-brands-chrome: `Perguntar onde salvar cada arquivo antes de fazer download` nas configurações do navegador __Chrome__
{ .card }

:fontawesome-brands-chrome: Aceitar cookies nos sites das certidões
{ .card }
